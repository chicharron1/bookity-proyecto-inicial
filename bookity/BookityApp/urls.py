...
from .views import inicio, login, registro, cerrar, publicar, publicaciones, perfil, detalle, eliminar_comentario, eliminar_publicacion, cerrar_trato, cancelar_trato, editar_perfil, eliminar_cuenta, calificar_usuario, eliminar_calificacion, usuarios_perfil, notificaciones, eliminar_notificacion, eliminar_todas_notificaciones, sobre_nosotros, gachalife, guardar_avatar
...
urlpatterns = [
    ...
    path('gachalife/', gachalife, name='gachalife'),
    path('gachalife/guardar/', guardar_avatar, name='guardar_avatar'),
]